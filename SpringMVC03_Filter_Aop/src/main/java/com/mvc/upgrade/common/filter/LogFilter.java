...
public class LogFilter implements Filter {
	...
	@Override
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) // FilterChain : filter 와 filter, filter 와 servlet 연결 filterchaining을 통해서
